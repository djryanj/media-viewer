...
test.describe('Lightbox - Image Viewing', () => {
...
test.describe('Video Player', () => {
    ...
    test('should seek forward with arrow key', async ({ page }) => {
        const videoItem = page.locator('.gallery-item.video').first();
    ...
    test('should seek backward with arrow key', async ({ page }) => {
        const videoItem = page.locator('.gallery-item.video').first();
...
test.describe('Lightbox - Mobile Touch Gestures', () => {
    test.beforeEach(async ({ page, loginHelpers }) => {
